    ...
    <div class="container">
      <div class="row gy-4">
        ...
        <div class="col-lg-3 col-md-12 footer-contact text-center text-md-start">
          ...
          <p>
            Locmaria Handball <br>
            34 Rue de LANVENNEC 29200 BREST FRANCE<br>
            29200 BREST FRANCE <br><br>
            <strong>Phone:</strong>29200 BREST FRANCE<br>
            <strong>Email:</strong>  ch.kervell@gmail.com<br>
          </p>
  ...
  <script src="<?php echo base_url();?>style/vendor/purecounter/purecounter_vanilla.js"></script>
