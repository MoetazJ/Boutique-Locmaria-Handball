...
<head>
  ...
  <title>Locmaria Handball</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link  href='<?php echo base_url();?>style/css/main.css' rel="icon">
  <link  href='<?php echo base_url();?>style/css/main.css' rel="apple-touch-icon">
  ...
  <header id="header" class="header d-flex align-items-center">
    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      <a href="<?php echo base_url();?>" class="logo d-flex align-items-center">
        ...
        <h1>Locmaria<span>.</span></h1>
      </a>
      <nav id="navbar" class="navbar">
        <ul>
          <li><a href="<?php echo base_url() ?>">Accueil</a></li>
          <li><a href="#portfolio">Produits</a></li>
          <li><a href="<?php echo base_url() ?>">Team</a></li>
